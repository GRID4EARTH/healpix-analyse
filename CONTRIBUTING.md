# Contributing to healpix-analyse
...
- Report bugs or request features through
  [GitHub Issues](https://github.com/GRID4EARTH/healpix-analyse/issues).
- For non-trivial changes, open an
  [issue](https://github.com/GRID4EARTH/healpix-analyse/issues/new) before starting work so the
  approach can be discussed with the maintainers.
- Fork the repository and create a focused feature branch for each change.
...
- Run the relevant tests and documentation build before submitting.
- Document temporary dependencies on unreleased branches in the pull request.
